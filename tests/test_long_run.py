...
class LongRunIntegrationTests(unittest.TestCase):
    ...
    def test_full_group_fast_run_hits_coverage_100(self) -> None:
        output_dir = ROOT / "generated" / "projects" / "proj-test-longrun-pass" / "long-run" / "fast-pass"
    ...
    def test_injected_isolation_violation_returns_code_2(self) -> None:
        output_dir = ROOT / "generated" / "projects" / "proj-test-longrun-isolation" / "long-run" / "inject-isolation"
        cmd = self._base_cmd("proj-test-longrun-isolation", output_dir) + ["--inject-isolation-violation"]
        proc = run_cmd(cmd)
    ...
    def test_injected_deadlock_returns_code_3(self) -> None:
        output_dir = ROOT / "generated" / "projects" / "proj-test-longrun-deadlock" / "long-run" / "inject-deadlock"
    ...
    def test_injected_gate_exposure_failure_returns_code_5(self) -> None:
        output_dir = ROOT / "generated" / "projects" / "proj-test-longrun-gate" / "long-run" / "inject-gate"
        cmd = self._base_cmd("proj-test-longrun-gate", output_dir) + ["--inject-gate-expose-failure"]
        proc = run_cmd(cmd)
    ...
    def test_audit_mode_preserves_isolation_and_changes_install_behavior(self) -> None:
        output_dir = ROOT / "generated" / "projects" / "proj-test-longrun-audit" / "long-run" / "audit-mode"
    ...
    def test_deterministic_events_with_fixed_seed(self) -> None:
        output_a = ROOT / "generated" / "projects" / "proj-test-longrun-deterministic" / "long-run" / "run-a"
        output_b = ROOT / "generated" / "projects" / "proj-test-longrun-deterministic" / "long-run" / "run-b"
        ...
        self.assertEqual(proc_a.returncode, 0, msg=f"stdout:\n{proc_a.stdout}\nstderr:\n{proc_a.stderr}")
        self.assertEqual(proc_b.returncode, 0, msg=f"stdout:\n{proc_b.stdout}\nstderr:\n{proc_b.stderr}")
    ...
    def test_lease_retry_succeeds_under_injected_contention(self) -> None:
        output_dir = ROOT / "generated" / "projects" / "proj-test-longrun-contention" / "long-run" / "contention"
