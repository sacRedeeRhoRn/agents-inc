...
echo "Tip: managed skills are project-scoped under <project-root>/.agents-inc/codex-home/skills/local"
echo "Tip: list projects with: agents-inc list"
echo "Tip: list reusable catalog groups with: agents-inc groups list"
echo "Tip: list project skills with: agents-inc skills list --project-id <id>"
